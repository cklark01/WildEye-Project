...
app.post('/sendData', function(req, res) {
    ...
    let deviceData = [req.body.date.split('T')[0],req.body.time,req.body.temp,req.body.hum,req.body.ax,req.body.ay,req.body.az,req.body.lat,req.body.lon,req.body.Batt,req.body.SdCapacity];
